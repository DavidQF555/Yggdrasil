...
import io.github.davidqf555.minecraft.yggdrasil.common.blocks.TeleporterBlock;
...
public final class BlockRegistry {
    ...
    public static final RegistryObject<TeleporterBlock> RUNIC_TELEPORTER = register("runic_teleporter", () -> new TeleporterBlock(AbstractBlock.Properties.of(Material.STONE)));
